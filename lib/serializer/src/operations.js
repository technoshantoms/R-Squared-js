...
export const personal_data_v2_create_operation_fee_parameters = new Serializer(
    "personal_data_v2_create_operation_fee_parameters", {
        fee: uint64,
        price_per_kbyte: uint32
    }
);

export const personal_data_v2_remove_operation_fee_parameters = new Serializer(
    "personal_data_v2_remove_operation_fee_parameters", {
        fee: uint64
    }
);
...
export const ico_balance_claim_operation_fee_parameters = new Serializer("ico_balance_claim_operation_fee_parameters");
...
var fee_parameters = static_variant([
    ...
    credit_deal_update_operation_fee_parameters,
    limit_order_update_operation_fee_parameters,
    ico_balance_claim_operation_fee_parameters,
]);
...
export const generic_operation_result = new Serializer("generic_operation_result", {
    new_objects: set(object_id_type),
    updated_objects: set(object_id_type),
    removed_objects: set(object_id_type),
});

export const generic_exchange_operation_result = new Serializer("generic_exchange_operation_result", {
    paid: array(asset),
...
export const vote_counter_update = new Serializer("vote_counter_update", {
    fee: asset,
    master_account: protocol_id_type("account"),
    vote_data: map(protocol_id_type("object"), uint32),
});

export const commit_create = new Serializer("commit_create", {
    fee: asset,
    account: protocol_id_type("account"),
    hash: string,
});

export const reveal_create = new Serializer("reveal_create", {
    fee: asset,
    account: protocol_id_type("account"),
    value: uint64,
});

export const commit_create_v2 = new Serializer("commit_create_v2", {
    fee: asset,
    account: protocol_id_type("account"),
    hash: string,
...
export const reveal_create_v2 = new Serializer("reveal_create_v2", {
    fee: asset,
    account: protocol_id_type("account"),
    value: uint64,
    maintenance_time: uint32,
...
export const commit_create_v3 = new Serializer("commit_create_v3", {
    fee: asset,
    account: protocol_id_type("account"),
    hash: string,
    maintenance_time: uint32,
...
export const reveal_create_v3 = new Serializer("reveal_create_v3", {
    fee: asset,
    account: protocol_id_type("account"),
    value: uint64,
    maintenance_time: uint32,
...
export const personal_data_v2_create = new Serializer("personal_data_v2_create", {
    fee: asset,
    subject_account: protocol_id_type("account"),
    operator_account: protocol_id_type("account"),
    url: string,
...
export const personal_data_v2_remove = new Serializer("personal_data_v2_remove", {
    fee: asset,
    subject_account: protocol_id_type("account"),
    operator_account: protocol_id_type("account"),
    hash: string,
...
export const ico_balance_claim = new Serializer("ico_balance_claim", {
    fee: asset,
    deposit_to_account: protocol_id_type("account"),
...
export const graphene_custom_operations_account_storage_map = new Serializer("graphene_custom_operations_account_storage_map", {
    remove: bool,
    catalog: string,
